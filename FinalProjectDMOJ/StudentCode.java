...
//    public static int minKnightMoves(int x, int y, int endX, int endY, boolean[][] visited) {
//        
//        if (x == endX && y == endY) {
//            return 0;
//        }
...
//
//            // Check if the new position is within bounds and not visited
//            if (newX >= 1 && newX <= 8 && newY >= 1 && newY <= 8 && !visited[newY-1][newX-1]) {
//                // Recursive call and calculate the minimum moves
//                int movesN = 1 + minKnightMoves(newX, newY, endX, endY, visited);
//                minMoves = Math.min(minMoves, movesN);
//                return minMoves;
//            }
//        }
//
//        // Unmark the current position before returning (backtracking)
